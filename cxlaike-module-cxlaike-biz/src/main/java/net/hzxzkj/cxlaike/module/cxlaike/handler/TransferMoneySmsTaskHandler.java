...
@Slf4j
@Service
public class TransferMoneySmsTaskHandler implements TaskHandler {
  ...
  public String getType() {
    return TaskHandlerEnum.TRANSFER_MONEY_SMS.getValue();
  }
  ...
  public TaskHandlerResult invoke(String params) {
    ...
    try {
      ...
      walletOrderWithdrawService.sendSmsForRemit(detailReqVOS);
    } catch (Exception e) {
      e.printStackTrace();
